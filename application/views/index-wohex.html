...
<!-- Mirrored from eazzy.me/html/imevent/index-wohex.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 02 Apr 2019 09:52:22 GMT -->
<head>
    <meta charset="utf-8">
...
<div class="wrapper">
    ...
    <div class="content-area">
                                ...
                                <div class="col-md-6 col-lg-4">
                                    ...
                                    <div class="form-header color">
                                        <h1 class="section-title">
                                            <span class="icon-inner"><span class="fa-stack"><i class="fa wohex fa-stack-2x"></i><i class="fa fa-ticket fa-stack-1x"></i></span></span>
        ...
        <section class="page-section" id="about">
            <div class="container">
                <h1 class="section-title">
                    <span data-animation="flipInY" data-animation-delay="300" class="icon-inner"><span class="fa-stack"><i class="fa wohex fa-stack-2x"></i><i class="fa fa-star fa-stack-1x"></i></span></span>
        ...
        <section class="page-section color" id="donation">
            <div class="container">
                <h1 class="section-title">
                    <span data-animation="flipInY" data-animation-delay="300" class="icon-inner"><span class="fa-stack"><i class="fa wohex fa-stack-2x"></i><i class="fa fa-ticket fa-stack-1x"></i></span></span>
        ...
        <section class="page-section" id="sponsors">
            <div class="container">
                <h1 class="section-title">
                    <span data-animation="flipInY" data-animation-delay="100" class="icon-inner"><span class="fa-stack"><i class="fa wohex fa-stack-2x"></i><i class="fa fa-thumbs-up fa-stack-1x"></i></span></span>
        ...
        <section class="page-section color">
            <div class="container">
                <h1 class="section-title">
                    <span data-animation="flipInY" data-animation-delay="300" class="icon-inner"><span class="fa-stack"><i class="fa wohex fa-stack-2x"></i><i class="fa fa-comments fa-stack-1x"></i></span></span>
                ...
                <div id="testimonials" class="owl-carousel testimonials" data-animation="fadeInUp" data-animation-delay="100">
                    ...
                    <div class="media testimonial">
                        <div class="media-object pull-right" data-animation="flipInY" data-animation-delay="300">
                            <div class="wohexagon testimonial-avatar">
        ...
        <section class="page-section light" id="speakers">
            <div class="container">
                <h1 class="section-title">
                    <span data-animation="flipInY" data-animation-delay="300" class="icon-inner"><span class="fa-stack"><i class="fa wohex fa-stack-2x"></i><i class="fa fa-user fa-stack-1x"></i></span></span>
                ...
                <div class="row thumbnails clear">
                    <div class="col-sm-6 col-md-3" data-animation="fadeInUp" data-animation-delay="100">
                        <div class="thumbnail no-border no-padding no-radius text-center">
                            <div class="media">
                            ...
                            <div class="caption">
                                ...
                                <ul class="social-line social-wohex list-inline text-center">
        ...
        <section class="page-section light">
            <div class="container">
                <div class="row">
                    <div class="col-md-8 pull-left">
                        <h1 class="section-title">
                            <span data-animation="flipInY" data-animation-delay="300" class="icon-inner"><span class="fa-stack"><i class="fa wohex fa-stack-2x"></i><i class="fa fa-question fa-stack-1x"></i></span></span>
        ...
        <section class="page-section">
            <div class="container">
                <h1 class="section-title">
                    <span data-animation="flipInY" data-animation-delay="300" class="icon-inner"><span class="fa-stack"><i class="fa wohex fa-stack-2x"></i><i class="fa fa-file-text-o fa-stack-1x"></i></span></span>
    ...
    <footer class="footer">
        <div class="footer-meta">
            <div class="container text-center">
                ...
                <span class="copyright" data-animation="fadeInUp" data-animation-delay="100">&copy; 2015 im Event &#8212; An One Page Event Manager Theme Designed & Developed By <a href="https://jthemes.com/" target="_blank" title="Top HTML Templates">Jthemes Studio</a></span>
            </div>
        </div>
    </footer>
    <!-- /FOOTER -->
